  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: ListView(
          children: [ListViewItem(listProduct: myProductList[0], onItemSelected:  MyOnItemSelectOrTap),
            ListViewItem(listProduct: myProductList[1], onItemSelected:  MyOnItemSelectOrTap),
            ListViewItem(listProduct: myProductList[2], onItemSelected:  MyOnItemSelectOrTap),
            ListViewItem(listProduct: myProductList[3], onItemSelected:  MyOnItemSelectOrTap),
            ListViewItem(listProduct: myProductList[4], onItemSelected:  MyOnItemSelectOrTap)
          ])
      ),
